...
def grade(problem_name, student_response):
    ...
    p = subprocess.Popen(["py.test", "{0}_test_runner.py".format(
        problem_name['problem_name']), program_name, "-v"], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
...
if __name__ == '__main__':
    server = ThreadedHTTPServer(('localhost', 1711), Handler)
